...
export default function ScopeSection() {
  ...
  return (
    <>
      ...
      <section className="hidden sm:block bg-[#F5F5F5] mt-18.5">
        <div className="ml-21.25 mr-22.5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
            {services.map((service, index) => (
              ...
              >
                {/* ARROW CORNER */}
                <div className="absolute top-0 right-0 z-20 flex items-center gap-3 pr-6 pt-6">
      ...
      <section className="block sm:hidden bg-[#F5F5F5] mt-16 px-4">
        <div className="max-w-screen-sm mx-auto">
          ...
          >
            Counsel throughout the corporate lifecycle, from structuring to
            transactions and defense
          </h2>

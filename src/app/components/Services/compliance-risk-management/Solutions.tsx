...
export default function OurSolutionsSection() {
  ...
  return (
    ...
    <>
      ...
      <section className="hidden sm:block mt-23.5 ml-22.75 mr-16.75   bg-[#F5F5F5] ">
        {/* HEADER */}
                  ...
                  <div className="relative bg-[#F5F5F5] group-hover:bg-white">
                    ...
                    <div className="relative grid grid-cols-1 md:grid-cols-[292px_463px] h-48.5">
                      ...
                      <div className="relative h-full pl-5.5 pr-2.5 py-8 flex items-center">
                        ...
                        {/* TITLE TEXT */}
                        <h3
                          className={`relative z-10 text-[#193170] text-[24px]  leading-8.5 font-medium ${ibmPlexSerif.className}`}
                        >
                          {item.title}
                        </h3>
                      </div>

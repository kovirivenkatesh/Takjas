...
export default function ProofOfCompetenceSection() {
    return (
        <section className="max-w-6xl mx-auto mt-5 mb-20">
            ...
            >
                Expertise proven across Dispute<br /> Resolution
            </h2>
                    ...
                    >
                        ...
                        <div className="relative col-span-2 overflow-hidden">
                            ...
                            <div className="relative z-10 grid grid-cols-[90px_1fr]">
                                ...
                                {/* CLIENT NAME */}
                                <div
                                    className={`px-4 py-10 text-2xl font-semibold text-[#193170] group-hover:text-white whitespace-pre-line transition-colors duration-500  ${ibmPlexSerif.className}`}
                                >
                                    {m.client}
                                </div>
                            </div>

...
const services = [
  {
    ...
    desc:
      "Strategic representation in complex corporate, contract, and shareholder disputes before German courts.",
  },
  {
    id: "02",
    title: "Arbitration & \nMediation",
    desc:
      "Managing national and international arbitration proceedings as a preferred, efficient alternative to formal court trials.",
  },
  {
    id: "03",
    title: "Pre-Litigation\n Strategy",
    desc:
      "Early risk assessment, evidence securing, and strategic negotiation to resolve disputes before formal court proceedings begin.",
  },
  {
    id: "04",
    title: "Enforcement & \nDefense",
    desc:
      "Securing and enforcing complex claims (e.g., liability and contractual rights) and managing defense against litigation and creditor claims.",
  },
];
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20">
      ...
      <h2 className={`text-4xl font-serif max-w-4xl mb-14 leading-tight ${ibmPlexSerif.className} `}>
       A Disciplined Approach to Conflict Resolution
      </h2>

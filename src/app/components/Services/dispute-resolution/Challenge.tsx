...
const items = [
  {
    title: "Escalation and Uncontrolled Litigation Costs",
    content:
      "Litigation consumes resources. Without strategy, disputes drag on, causing unpredictable outcomes and costs.",
  },
  {
    title: "The Failure of Contract Enforcement",
    content:
      "A legal claim is valuable only if enforceable. We tackle the complexities of enforcing claims from breach of contract and liability.",
  },
];
      ...
      <div className="hidden sm:block">
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12.25  mt-23.5 ml-22.75 mr-16.75">
          ...
          <div className="relative h-124.25 w-139 overflow-hidden">
            <Image
              src="/Images/dispute-challenge.jpg"
          ...
          <div>
            ...
            <h2 className={`text-[48px]  ${ibmPlexSerif.className} mb-2.5 font-medium text-[#2C2C2C] leading-17.75`}>
              Identifying the Core Threats to Your Business Continuity
            </h2>

            <p className="text-[#5E6784] mb-7   leading-6.25 text-[16px]">
              Commercial conflicts extend far beyond the courtroom, posing significant threats to reputation, capital, and business focus. We provide a critical assessment of the two central areas where disputes can severely jeopardize your corporate objectives.
            </p>
        ...
        <section className="flex flex-col gap-10">
          ...
          <div>
            ...
            <p className="text-[#5E6784] mb-8 leading-6 text-[14px]">
              The cost of non-compliance extends far beyond fines; it compromises
              the trust that founders and investors place in your company.
              Before building new systems, it is vital to strategically analyze
              complex regulatory threats.
            </p>

...
export default function GetInTouchSection() {
  ...
  <span className="text-[#193170]">
     Finance & Restructuring
            ...
            >
              Structuring Capital and Strategic Restructuring
            </h2>

            <p className="text-sm text-gray-600 mb-6 max-w-lg">
              Expert legal counsel essential for navigating critical financing
              structures, managing corporate debt, and ensuring stability during

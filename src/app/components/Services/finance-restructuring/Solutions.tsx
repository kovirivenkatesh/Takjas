...
const services = [
  {
    ...
    title: "Venture Debt &\n Structured Finance",
    desc:
      "Structuring complex secured lending, venture debt, and credit facilities to facilitate market expansion and growth.",
  },
  {
    id: "02",
    title: "Insolvency & \nExecutive Defense",
    desc:
      "Advising executives on their duties and providing defense strategies against creditor and insolvency avoidance claims.",
  },
  {
    id: "03",
    title: "Corporate \nReorganization",
    desc:
      "Legal execution of complex corporate reorganizations, operational work-outs, and separation processes outside of formal court insolvency.",
  },
  {
    id: "04",
    title: "Refinancing & Capital Structures",
    desc:
      "Legal review and documentation for mid-market company refinancing deals and capital structure optimization.",
  },
];
  ...
  return (
    <section className="max-w-7xl mx-auto px-10 py-20">
      ...
      <h2 className={`text-4xl font-serif max-w-4xl mb-14 leading-tight ${ibmPlexSerif.className} `}>
        Our integrated approach to structuring capital <br />and securing financial stability
      </h2>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="relative group overflow-hidden border border-[#C9D3EA] bg-white">
            ...
            <div className="relative z-10 flex flex-col">
              {/* HEADER */}
              <div className="bg-[#193170] text-white px-6 py-4">
                ...
                {["Name", "Email", "Phone No.", "Message"].map((label, i) => (
                  <div key={i} className="relative overflow-hidden">
                    ...
                    {label === "Message" ? (
                      <textarea
                        placeholder={label}
                        className="relative z-10 w-full h-28 resize-none px-4 py-3 bg-[#EAF1FF] group-hover:bg-transparent text-[#193170] placeholder-[#5E6784] outline-none"
                      />
                    ) : (
                      <input
                        placeholder={label}

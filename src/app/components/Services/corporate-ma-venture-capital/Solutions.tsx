...
const services = [
  {
    ...
    desc:
      "We actively manage the legal execution of Venture Capital transactions, specializing in the negotiation and documentation of Seed to Series B+ financing rounds. Our expertise extends to complex financial instruments such as venture debt and convertible loans.",
  },
  {
    id: "02",
    title: "Corporate Structuring \n& Governance",
    desc:
      "Establishing a robust legal foundation is crucial. We advise founders on formation, governance, and establishing effective corporate structures (GmbH/UG). A core focus is designing effective Employee Incentive Programs (ESOPs/VSOPs)",
  },
  {
    id: "03",
    title: "M&A and Strategic\n Exits",
    desc:
      "We provide sophisticated advice on both buy-side and sell-side Mergers & Acquisitions. Our role is to lead the legal strategy, ensuring optimal legal outcomes during acquisitions, asset deals, and corporate spin-offs",
  },
  {
    id: "04",
    title: "Incentive Programs (ESOP/VSOP)",
    desc:
      "Effective equity-based incentive programs are vital for attracting and keeping top talent. We specialize in structuring compliant ESOPs and VSOPs, ensuring your scheme is appealing and aligned with your financing and tax goals.",
  },
];
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20">
      ...
      <h2 className={`text-4xl font-serif max-w-4xl mb-14 leading-tight ${ibmPlexSerif.className} `}>
        Our integrated methodology for structuring <br/>success across the entire corporate lifecycle
      </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            >
              ...
              <div className="flex">
                ...
                <div className="relative flex-1 px-10 py-8 bg-[#F5F5F5] group-hover:bg-white">
                  ...
                  <div className="relative  grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-6 items-center ">
                    {/* TITLE */}
                    <h3 className={`text-[#193170] text-lg font-semibold whitespace-pre-line ${ibmPlexSerif.className} `}>
                      {item.title}
                    </h3>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="relative group overflow-hidden border border-[#C9D3EA] bg-white">
            ...
            <div className="relative z-10 flex flex-col">
              ...
              <div className="px-6 py-5 space-y-4">
                ...
                <button className="w-full bg-[#193170] text-white py-4">
                  Submit
                </button>
              </div>
            </div>
          ...
          <div className="row-span-1 bg-[#393E49] text-white px-6 py-5 flex flex-col justify-center mt-2">

  ...
  return (
    ...
    <>
      ...
      <div className="block sm:hidden mt-20 ">
        ...
        {/* ===== FAQ SECTION ===== */}
        <section className="px-6 sm:px-10 lg:ml-20.75 lg:mr-17.75 mt-12 sm:mt-16 lg:mt-20 mb-10 sm:mb-12 lg:mb-14.25 bg-[#F5F5F5]">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 lg:gap-30.5">
            ...
            <div>
              ...
              <h2
                className={`text-3xl sm:text-4xl lg:text-[55px] leading-tight lg:leading-17.75 mb-6 sm:mb-8 lg:mb-9.75 font-medium ${ibmPlexSerif.className}`}

              >
                Clarifying our expertise and client process.
              </h2>

              <p className="text-[15px] sm:text-[16px] text-[#676767] leading-6 max-w-md">
                We address the common concerns of founders and investors upfront.
                Our commitment to transparent communication ensures you have the
                necessary information to proceed with confidence.
              </p>
            ...
            <div className="mt-6 md:mt-8">
              {faqs.map((item, index) => (
                <div key={index} className="border-b border-[#F2C94C]">

                  <div
                    onClick={() => toggleFAQ(index)}
                    className="flex items-center justify-between py-4 cursor-pointer"
                  >
                    <span className="text-[#193170] text-lg sm:text-[20px] lg:text-[22px] font-medium pr-4">
                      {item.q}
                    </span>

                    <span
                      className={`text-xl sm:text-[24px] text-[#193170] transition-transform duration-300 ${openIndex === index ? "rotate-45" : ""
                        }`}
                    >
                      +
                    </span>
                  ...
                  >
                    <p className="pb-4 text-sm text-gray-600 leading-6">
                      {item.a}
                    </p>
                  </div>

  ...
  return (
    <>
      ...
      <div className="hidden sm:block bg-[#F5F5F5]">
        ...
        >
          ...
          <div className="ml-20 mt-16.75 self-start">
            <p className="text-[16px] mb-9.75 text-[#5E6784]">
              <Link
                href="/"
            ...
            <h1 className={`text-[55px] font-medium leading-17.75 mb-5.25 text-[#1f2937] ${ibmPlexSerif.className}  leading-tight mb-6`}>
            ...
            <h3 className="text-[32px] font-medium leading-17.75 mb-5.25">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-[#1e3a8a] text-white text-[24px] leading-6.25 p-4"
            >
              <Mail size={35} />
              career@takjas.com
            </a>
          ...
          {/* RIGHT IMAGE + CURTAIN */}
          <div className="relative w-156.25 h-178.75 overflow-hidden shrink-0">

            {/* IMAGE */}
            <motion.img
              src="/Images/aboutus.png"
              alt="Career"
              className="absolute inset-0 w-156.25 h-full object-cover"
              initial={{ scale: 1.15 }}
              animate={{ scale: 1 }}
              transition={{
                duration: 1.5,
      ...
      <div className="block sm:hidden bg-[#F5F5F5]">
        <section
          ref={sectionRef}
          className="flex flex-col px-6 pt-28 pb-12"
        >
          {/* Breadcrumb */}
          <p className="text-sm mb-6 text-[#5E6784]">
          ...
          {/* Heading */}
          <h1
            className={`text-3xl font-medium leading-tight mb-6 text-[#1f2937] ${ibmPlexSerif.className}`}
          >
            Build Your Legal Future
            <br />
            in the Digital Economy
          ...
          <p className="text-[#5E6784] mb-8 text-base leading-6">
            Are you an A-player who thrives on challenges? We have projects that
            offer growth and fun in a dynamic environment. We value your journey
          ...
          <p className="text-[#5E6784] mb-6 text-sm leading-6">
            If you are interested, please reach out. We look forward to
            receiving your CV and supporting documents.
          </p>

          {/* Email Button */}
          <a
            href="mailto:career@takjas.com"
            className="flex items-center justify-center gap-3 bg-[#1e3a8a] text-white text-base py-4 rounded-md"
          >
            <Mail size={20} />
            career@takjas.com
          </a>
          ...
          {/* IMAGE + CURTAIN */}
          <div className="relative w-full h-64 mt-10 overflow-hidden rounded-md">
            <motion.img
              src="/Images/aboutus.png"
              alt="Career"
        ...
        <div className="">
          ...
          <section
            ref={sectionRef}
            className="relative bg-[#0b1633] py-14 sm:py-16 lg:py-19 text-center overflow-hidden px-6"
          >
            ...
            <Image
              ...
              width={434}
              height={434}
              className={`absolute bottom-0 left-0 pointer-events-none transform ${isVisible ? "translate-x-0 translate-y-0" : "-translate-x-full translate-y-full"} transition-transform duration-1500 ease-out w-40 sm:w-60 h-auto`}
            ...
            <Image
              ...
              width={434}
              height={434}
              className={`absolute bottom-0 right-0 pointer-events-none transform ${isVisible ? "translate-x-0 translate-y-0" : "translate-x-full translate-y-full"} transition-transform duration-1500 ease-out delay-150 w-40 sm:w-60 h-auto`}

            />

            {/* CONTENT */}
            <h2
              className={`relative z-10 text-3xl sm:text-4xl lg:text-[55px] leading-tight lg:leading-17.75 text-white mb-6 sm:mb-8 max-w-4xl mx-auto ${ibmPlexSerif.className}`}

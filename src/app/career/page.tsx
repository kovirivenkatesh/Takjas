    ...
    <>
      ...
      <div className="block sm:hidden bg-[#F5F5F5]">
        <section
          ...
          className="relative flex flex-col lg:flex-row items-start gap-10 lg:gap-21.75 px-6 lg:px-20 pt-12 lg:pt-16.75"
        ...
        >
          ...
          <div className="w-full lg:w-auto">
            ...
            {/* Breadcrumb */}
            <p className="text-[14px] lg:text-[16px] mb-6 lg:mb-9.75 text-[#5E6784]">
              <Link
                href="/"
                className="hover:text-[#193170] transition-colors"
              >
            ...
            {/* Heading */}
            <h1
              className={`text-[32px] sm:text-[40px] lg:text-[55px] 
      font-medium leading-tight mb-6 text-[#1f2937] 
      ${ibmPlexSerif.className}`}
            ...
            {/* Description */}
            <p className="text-[#5E6784] mb-8 text-[14px] lg:text-[16px] leading-6.5">
              Are you an A-player who thrives on challenges? We have projects that offer growth and fun in a dynamic environment. We value your journey and offer competitive compensation. Contact us to start a rewarding career!
            </p>

            {/* Subheading */}
            <h3 className="text-[24px] lg:text-[32px] font-medium mb-4">
              Send us your application!
            </h3>
            ...
            <a
              href="mailto:career@takjas.com"
              className="inline-flex items-center gap-3 bg-[#1e3a8a] text-white text-[16px] lg:text-[24px] px-6 py-4"
          ...
          {/* RIGHT IMAGE + CURTAIN */}
          <div className="relative w-full    h-75  overflow-hidden shrink-0">

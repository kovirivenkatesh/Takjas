  ...
  <div className=" mx-20.75 relative  grid grid-cols-1 md:grid-cols-2 gap-30.5 pt-19.5 pb-13">
    ...
    <form className="space-y-8 relative z-10">
     ...
     <footer className="bg-[#F5F5F5]  mt-13 relative overflow-hidden ">
          ...
          <div className="absolute right-0 bottom-0 translate-y-20 opacity-0 transition-all duration-700 ease-out group-hover:translate-y-0 group-hover:opacity-15 pointer-events-none z-10"
          >
